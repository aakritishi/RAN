export const SubServices = ({ image, title, description, link }) => {
    return (
      <div className="services relative bg-transparent-black my-2 w-full md:w-1/3 lg:w-1/4 p-4">
        ...
        <div>
          <h2 className=" px-3 py-2 text-black  md:right-2 lg:right-4  text-center">
            {title} 
          </h2>
        </div>
